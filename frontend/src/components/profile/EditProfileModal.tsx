      ...
      <div className="bg-white rounded-2xl border border-gray-200 shadow-xl w-full max-w-md p-5 space-y-4">
        ...
        <form onSubmit={handleSave} className="space-y-3">
          ...
          <div className="grid grid-cols-2 gap-2">
            <div>
              <label className="block text-xs font-medium text-gray-700 mb-1">Magaalada (City)</label>
              <input
                type="text"
                required
                value={city}
            ...
            <div>
              <label className="block text-xs font-medium text-gray-700 mb-1">Xaafadda (District)</label>
              <input
                type="text"
                required
                value={district}
          ...
          <div>
            <label className="block text-xs font-medium text-gray-700 mb-1">Gobolka / Region</label>
            <input
              type="text"
              required
              value={region}
