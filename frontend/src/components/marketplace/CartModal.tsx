...
export function CartModal({
  ...
  const handleCheckout = (e: React.FormEvent) => {
    ...
    const newOrder: MarketplaceOrder = {
      ...
      customer_phone: customerPhone.trim() || '+252 61 555 1234',
            ...
            <form onSubmit={handleCheckout} className="space-y-4 pt-3 border-t border-gray-100">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  >
                    <option value="Muqdisho">Banaadir (Muqdisho)</option>
                    <option value="Hargeysa">Woqooyi Galbeed (Hargeysa)</option>
                    <option value="Baydhabo">Bay (Baydhabo)</option>
                    <option value="Boosaaso">Bari (Boosaaso)</option>
                    <option value="Garowe">Nugaal (Garowe)</option>
                    <option value="Kismaayo">Jubbada Hoose (Kismaayo)</option>
                    <option value="Beledweyne">Hiiraan (Beledweyne)</option>
                    <option value="Dhusamareeb">Galguduud (Dhusamareeb)</option>
                  </select>
                </div>
              </div>
