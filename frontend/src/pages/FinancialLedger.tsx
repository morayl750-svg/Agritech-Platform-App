...
import { Plus, Download, Printer, ShieldAlert } from 'lucide-react'
    ...
    <div className="w-full flex flex-col gap-6 items-stretch pb-10">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 pb-2 border-b border-gray-200">
        ...
        <div className="flex flex-wrap items-center gap-2 self-start sm:self-auto">
          ...
          {/* Add Transaction Button: Only Admin (Mohamed Rayl) */}
          {isAdmin && (
            <button
              type="button"
      ...
      {!isAdmin && (
        <div className="flex items-center gap-2.5 p-3 rounded-xl bg-blue-50/80 border border-blue-200 text-blue-800 text-xs">
          <ShieldAlert size={16} className="text-blue-600 flex-shrink-0" />
          <span>
            <strong>Koontada Macmiilka (Client View):</strong> Waxaad halkan ka eegi kartaa xisaabaadkaaga gaarka ah. Diiwaangelinta cusub iyo maamulka guud ee xisaabaadka nidaamka waxaa loo xiray Maamulaha (Mohamed Rayl).
          </span>
        </div>
      )}
